...
sudo sed -i "s/PROXY_MYSQL_PORT = ${PORT_RAW_PROXY}/PROXY_MYSQL_PORT = ${PORT_PROXY_MYSQL_SHARDING}/g" `grep "PROXY_MYSQL_PORT = ${PORT_RAW_PROXY}" -rl example-core/example-api/`
sudo sed -i "s/PROXY_POSTGRESQL_PORT = ${PORT_RAW_PROXY}/PROXY_POSTGRESQL_PORT = ${PORT_PROXY_PG_SHARDING}/g" `grep "PROXY_POSTGRESQL_PORT = ${PORT_RAW_PROXY}" -rl example-core/example-api/`
