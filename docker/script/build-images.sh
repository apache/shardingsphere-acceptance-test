...
sudo sed -i "s/localhost/${ip}/g" `grep localhost -rl example-core/example-raw-jdbc/`
sudo sed -i "s/3306/${PORT_JDBC_MYSQL}/g" `grep 3306 -rl example-core/example-raw-jdbc/`
sudo sed -i "s/5432/${PORT_JDBC_PG}/g" `grep 5432 -rl example-core/example-raw-jdbc/`
