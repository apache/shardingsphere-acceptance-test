...
sudo sed -i "s/3308/${PORT_PROXY_MYSQL_SHARDING}/g" `grep PROXY_MYSQL_PORT = ${PORT_RAW_PROXY} -rl example-core/example-api/`
sudo sed -i "s/3309/${PORT_PROXY_PG_SHARDING}/g" `grep PROXY_POSTGRESQL_PORT = ${PORT_RAW_PROXY} -rl example-core/example-api/`
