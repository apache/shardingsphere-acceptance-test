 ...
 * @author linzesi
 */
public class ShardingMasterSlaveEncryptTest {
    
    private static File getFile() {
        return new File(Thread.currentThread().getClass().getResource("/META-INF/sharding-master-slave-encrypt-databases.yaml").getFile());
    }
    ...
    public void assertEncryptDatabases() throws SQLException, IOException {
        ...
        SpringBootRawJdbcAssertUtils.assertShardingMasterSlaveEncrypt(exampleService);
    }
}
