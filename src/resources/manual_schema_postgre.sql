...
-- Should sync from master-salve automatically
 CREATE TABLE IF NOT EXISTS demo_ds_0.t_user_0 (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd VARCHAR(200), PRIMARY 
 KEY (user_id));
 CREATE TABLE IF NOT EXISTS demo_ds_0.t_user_1 (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd VARCHAR(200), PRIMARY 
 KEY (user_id));
 CREATE TABLE IF NOT EXISTS demo_ds_1.t_user_0 (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd VARCHAR(200), PRIMARY 
 KEY (user_id));
 CREATE TABLE IF NOT EXISTS demo_ds_1.t_user_1 (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd VARCHAR(200), PRIMARY 
 KEY (user_id));
 ...
 CREATE TABLE IF NOT EXISTS demo_ds_slave_0.t_user (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd VARCHAR(200), PRIMARY KEY (user_id));
 CREATE TABLE IF NOT EXISTS demo_ds_slave_1.t_user (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd VARCHAR(200), PRIMARY KEY (user_id));
 ...
 CREATE TABLE IF NOT EXISTS demo_ds_master_0_slave_0.t_user (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd VARCHAR(200), PRIMARY KEY (user_id));
 CREATE TABLE IF NOT EXISTS demo_ds_master_0_slave_1.t_user (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd VARCHAR(200), PRIMARY KEY (user_id));
 ...
 CREATE TABLE IF NOT EXISTS demo_ds_master_1_slave_0.t_user (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd VARCHAR(200), PRIMARY KEY (user_id));
 
 CREATE TABLE IF NOT EXISTS demo_ds_master_0_slave_0.t_user_0 (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd 
 VARCHAR(200), PRIMARY KEY (user_id));
 CREATE TABLE IF NOT EXISTS demo_ds_master_0_slave_0.t_user_1 (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd 
 VARCHAR(200), PRIMARY KEY (user_id));
 CREATE TABLE IF NOT EXISTS demo_ds_master_0_slave_1.t_user_0 (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd 
 VARCHAR(200), PRIMARY KEY (user_id));
 CREATE TABLE IF NOT EXISTS demo_ds_master_0_slave_1.t_user_1 (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd 
 VARCHAR(200), PRIMARY KEY (user_id));
 CREATE TABLE IF NOT EXISTS demo_ds_master_1_slave_0.t_user_0 (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd VARCHAR(200), PRIMARY KEY (user_id));
 CREATE TABLE IF NOT EXISTS demo_ds_master_1_slave_0.t_user_1 (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd 
 VARCHAR(200), PRIMARY KEY (user_id));
 CREATE TABLE IF NOT EXISTS demo_ds_master_1_slave_1.t_user_0 (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd 
 VARCHAR(200), PRIMARY KEY (user_id));
 CREATE TABLE IF NOT EXISTS demo_ds_master_1_slave_1.t_user_1 (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd 
 VARCHAR(200), PRIMARY KEY (user_id));
 CREATE TABLE IF NOT EXISTS demo_ds_master_1_slave_1.t_user (user_id SERIAL NOT NULL, user_name VARCHAR(200), user_name_plain VARCHAR(200), pwd VARCHAR(200), assisted_query_pwd VARCHAR(200), PRIMARY KEY (user_id));
